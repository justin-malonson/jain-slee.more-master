...
public class TCKExtension implements Extension {
     ...
     */
    public static final String SUBSYSTEM_NAME = "sleetck";
    ...
    private static final String RESOURCE_NAME = TCKExtension.class.getPackage().getName() + ".LocalDescriptions";

    static StandardResourceDescriptionResolver getResourceDescriptionResolver(final String keyPrefix) {
        String prefix = SUBSYSTEM_NAME + (keyPrefix == null ? "" : "." + keyPrefix);
        return new StandardResourceDescriptionResolver(prefix, RESOURCE_NAME, TCKExtension.class.getClassLoader(), true, false);
    }
    ...
    private static class SubsystemParser implements XMLStreamConstants, XMLElementReader<List<ModelNode>>, XMLElementWriter<SubsystemMarshallingContext> {
        ...
        public void writeContent(XMLExtendedStreamWriter writer, SubsystemMarshallingContext context) throws XMLStreamException {
            context.startSubsystemElement(TCKExtension.NAMESPACE, false);
